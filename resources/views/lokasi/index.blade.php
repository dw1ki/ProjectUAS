...
<head>
  ...
  <title>@yield('title')UniPark - Lokasi</title>
...
<body class="sub_page">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="lokasi">Lokasi<span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item"> 
  ...
  <section class="about_section layout_padding" id="a">
    <div class="container-fluid">
      <div class="row info_section ">
        ...
        <div class="col-md-6 col-lg-7 px-0">
          <div class="map_container">
            <div class="map">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15860.962600466144!2d106.8444993!3d-6.362893!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed6178a2b32f%3A0x20d7938791acfd4a!2sSTT%20Terpadu%20Nurul%20Fikri%20(Kampus%20A%20-%20Sekretariat)!5e0!3m2!1sid!2sid!4v1719765964366!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </div>
        </div>
      </div>
  ...
  <br><br><br>
    ...
    <section class="about_section layout_padding" id="b">
      <div class="container-fluid">
        <div class="row info_section ">
          <div class="col-md-5 col-lg-4 offset-md-1">
            <div class="form_container">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('landing_page/images/w1.png')}}" alt="">
            </div>            
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('landing_page/images/w2.png')}}" alt="">
            </div>            
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('landing_page/images/w3.png')}}" alt="">
            </div>            
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('landing_page/images/w4.png')}}" alt="">
            </div>            
          </div>
        </div>
      </div>      
